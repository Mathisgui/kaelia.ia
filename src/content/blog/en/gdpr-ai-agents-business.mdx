...
This check gets even stricter for professions bound by client confidentiality: we detail what that means concretely [in law firms](/en/blog/ai-in-law-firms).
