...
export const home: HomeContent = {
  meta: {
    ...
    description:
      "Kael'IA builds custom AI agents and automations that handle your email, documents, CRM, follow-ups and reporting. Free 30-minute assessment.",
  },

  hero: {
    title: "AI agents that handle your business tasks, right inside your tools.",
    description:
      "Kael'IA automates your company's email, documents, follow-ups, CRM and reporting with custom AI agents and workflows. Less re-keying. Fewer things slipping through the cracks. More time for your teams.",
  ...
  operations: {
    ...
    description:
      "Every company loses hours to the same tasks: sorting, re-keying, chasing, reporting. Here is what our agents and workflows handle for you.",
    items: [
      {
        icon: "mail",
  ...
  pedagogy: {
    ...
    description:
      "Two complementary building blocks. Knowing which is which keeps you from paying for AI where a simple workflow does the job better, and vice versa.",
    automation: {
      title: "The automation",
      description:
        "It runs a predefined scenario, the same one every time, reliably and with a full audit trail.",
      example:
    ...
    agent: {
      title: "The AI agent",
      description:
        "It reads variable content and chooses an action within boundaries you define.",
      example:
    ...
    combined: {
      ...
      description:
        "The agent understands and decides, the workflow executes and logs. That combination is what delivers reliable results in a business setting, with human review exactly where it matters.",
    },
  },
    ...
    steps: [
      {
        ...
        details:
          "We analyze your actual operations: email, documents, tools, double data entry. Deliverable: a prioritized list of your automatable processes, each with an estimate of the gains and the feasibility.",
      },
      {
        number: "02",
        title: "Prototype",
      ...
      },
      {
        ...
        details:
          "Workflow monitoring, anomaly fixes, business-rule tuning and usage cost tracking. You always know what the system is doing and what it is earning you.",
      },
    ],
  ...
  integrations: {
    ...
    description:
      "No new platform to adopt: agents and workflows plug into your existing environment.",
    tools: [
      "n8n",
      "Make",
      "Notion",
    ...
    items: [
      {
        ...
        answer:
          "An automation follows a predefined scenario (if X then Y), reliably and with a full audit trail. An AI agent reads variable content (an email, a document) and chooses an action within a defined scope. Most projects combine the two: the agent understands and decides, the workflow executes and logs.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Every deployment includes documentation and training for your teams. After that, an optional maintenance plan covers workflow monitoring, error fixes, integration updates and API cost tracking.",
      },
      {
