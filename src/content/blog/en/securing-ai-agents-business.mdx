...
Regulated professions push this logic further: [the ethical framework lawyers work under](/en/blog/ai-in-law-firms) requires that the final decision always stay with the professional, never with the agent.
